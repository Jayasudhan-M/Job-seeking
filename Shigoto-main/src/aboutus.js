    ...
    <div className="about-us-container">
      ...
      <header className="header-background">
        <div className="header-content">
          ...
          <p>
            Discover how Shigoto connects top talent with leading companies
      ...
      <main className="main-content">
        <section className="mission">
          <h2>Our Mission</h2>
          <p>
            At Shigoto, we are committed to bridging the gap between job seekers and employers. Our mission is to provide a platform that ensures the best match for both parties, fostering growth and success.
          </p>
        </section>
