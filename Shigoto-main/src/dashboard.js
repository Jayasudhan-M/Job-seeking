...
import CommunityFAQ from './CommunityFAQ.jsx';
...
const Dashboard = () => {
  ...
  const successStories = [
    { profilePic: profilePic1, name: 'Wade Wilson', jobTitle: 'Software Engineer at TCS', story: 'Landing my dream job at TCS was a game-changer for my career. Thank you Shigoto.' },
    { profilePic: profilePic2, name: 'Sarah Smith', jobTitle: 'Data Analyst at ICICI Bank', story: 'Shigoto provided me with the platform to grow and excel in my career.' },
    { profilePic: profilePic3, name: 'John Vooslo', jobTitle: 'Product Manager at Amazon', story: 'Shigoto has been a fantastic place to create my career.' }
  ];
